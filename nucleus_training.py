...
class NucleusConfig(Config):
    ...
    #STEPS_PER_EPOCH = (60 - len(VAL_IMAGE_IDS)) // IMAGES_PER_GPU
    ...
    ##kimyy
    # when image size = 2000px, out of GPU memory ( 12GB)
    # reszie half the original image
    #IMAGE_MAX_DIM = 1024   # original image 2048
    #IMAGE_MIN_DIM = 1024
    # IMAGE_MAX_DIM = 512
    ...
    # kimyy is enough?
    RPN_TRAIN_ANCHORS_PER_IMAGE = 128 # coco 256  # nuclues 64

    # Image mean (RGB)
    # kimyy mean_pixcel value is need?
    MEAN_PIXEL = np.array([185.7, 136.8, 172.2])
    ...
    #kimyy
    TRAIN_ROIS_PER_IMAGE = 128  #coco 128   # nuclues 128
...
class NucleusDataset(utils.Dataset):
    ...
    def load_nucleus(self, dataset_dir, subset):
        ...
        if subset == 'train':
           subset_dir = "train_images"

        elif subset =='val':
           subset_dir = "val_images"
        else:
           subset_dir = subset
        ...
        #kimyy
        #Get image ids from directory name
        #    #print (os.walk(dataset_dir)[1])
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        #kimyy
        #limit the number of mask up to 50
        #limit_mask_number = 100
        #index = 0
...
def train(model, dataset_dir, subset):
    ...
    #augmentation = iaa.augmenters.Fliplr(0.5)
